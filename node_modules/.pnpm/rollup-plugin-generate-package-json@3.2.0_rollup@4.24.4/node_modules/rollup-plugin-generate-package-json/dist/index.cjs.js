...
var readPackage = _interopDefault(require('read-pkg'));
...
function generatePackageJson(options = {}) {
  ...
  return {
    ...
    generateBundle: async (outputOptions, bundle) => {
      ...
      dependencies = Array.from(new Set([...dependencies, ...(Array.isArray(additionalDependencies) ? additionalDependencies : Object.keys(additionalDependencies))])).sort();
      ...
      const generatedContents = { ...(typeof baseContents === 'function' ? baseContents(inputFile) : baseContents),
